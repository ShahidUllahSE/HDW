  ...
  return (
    <div>
      ...
      <div className="slider mt-4 flex-col-reverse md:flex-row bg-[#f2f2f2] mx-24">
        ...
        <div className="text-center font-serif -ml-44">

          Join our community of strong and bold women! <br/><br/>
        </div>
...
Every penny counts and makes a difference in the lives of these women. Your support not only empowers them but also helps create a more inclusive and equitable society for all.
 ...
 Thank you for considering our cause. Your support means the world to us.
      ...
      <div className="left flex flex-col items-center md:items-baseline py-4   space-y-5">
  <p className="font-semibold ml-96 ">
    <div className="font-serif text-center ml-20">

    You can donate on
    </div>
  <br/>
  <div className="font-serif ml-24">
